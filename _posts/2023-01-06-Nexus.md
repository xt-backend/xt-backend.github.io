  ...
  - 1-2-1) daemon.json 실행
    ...
    - For Window
      ...
      - C:\Users/사용 계정 이름/.docker 이동 후 daemon.json 실행
        ...
        ![1-1](/assets/posts/nexus/1-1.png)
        
        ![1-1.png](/assets/posts/nexus/1-1.png)
    ...
    - 1-2-2) 해당 파일 내에 밑의 사진에서 표시된 내용 추가
        ...
        ![1-2-3-2.png](/assets/posts/nexus/1-2-3-2.png)
    
    - 1-2-3) Docker 재 시작
      
      ![1-2-4-2.png](/assets/posts/nexus/1-2-4-2.png)
...
- CLI
  ...
  - 예시 화면
    ...
    ![3-1-2.png](/assets/posts/nexus/3-1-2.png)

- DockerDesktop
  
  - Images탭에서 삭제할 이미지의 Delete
    
    ![3-2.png](/assets/posts/Nexus/3-2.png)
...
- CLI
  ...
  - 예시 화면
    ...
    ![4-0.png](/assets/posts/Nexus/4-0.png)

- DockerDesktop
  
  - Images탭에서 실행할 이미지의 Actions-Run 클릭
    
    ![4-1.png](/assets/posts/Nexus/4-1.png)
  
  - 실행과 관련된 설정 후 하단의 Run 클릭
    
    ![1-3-3.png](/assets/posts/Nexus/1-3-3.png)
...
- DockerDesktop
  ...
  - 서버 상태 및 Logs 확인
    ...
    ![1-4-3.png](/assets/posts/Nexus/1-4-3.png)
...
- 예상 예외 상황 2: **“Bind for 서버_ip:포트 failed: port is already allocated”**
    ...
    ![7-2.png](/assets/posts/Nexus/7-2.png)
  ...
  - 해결 방안:
    ...
    - 현재 실행 중인 container들 포트 확인
        ...
        ![7-3.png](/assets/posts/Nexus/7-3.png)
...
- 예상 예외 상황 3: **“Only one usage of each socket address (protocol/network address/port) is normally permitted.”**
    ...
    ![7-8.png](/assets/posts/Nexus/7-8.png)
    ...
    - 현재 컴퓨터에서 사용 중인 포트 확인 및 중복되는 포트 종료
      ...
      - For Window
        ...
        ```
          ...
          ![8-3-2.png](/assets/posts/Nexus/8-3-2.png)
      ...
      - For Mac
        ...
        ```
          ...
          ![8-3-3.png](/assets/posts/Nexus/8-3-3.png)

- 예상 예외 상황 4: **“image is being used by stopped(running) container CONTAINER_ID”**
  
    ![7-5.png](/assets/posts/Nexus/7-5.png)
  ...
  - 해결 방안:
    ...
    - 2) rmi -f 명령어 입력
      ...
      ![7-7.png](/assets/posts/Nexus/7-7.png)